...
open class Feature(
    ...
    fun inArea(): Boolean = area?.let { LocationUtils.area?.equals(it, true) ?: false } ?: true

    fun inSubarea(): Boolean = subarea?.let { LocationUtils.subarea?.contains(it, true) ?: false } ?: true
