...
object SlayerDisplay : Feature("slayerdisplay") {
    ...
    override fun initialize() {
        ...
        configRegister<RenderEvent.EntityPre>("slayerdisplayhideoriginalnametags") { event ->
        ...
        register<RenderEvent.EntityPost> { event ->
            slayerEntities[event.entity.id]?.displayText?.takeIf { it.isNotEmpty() }?.let { displayText ->
                Render3D.drawString(
                    displayText,
